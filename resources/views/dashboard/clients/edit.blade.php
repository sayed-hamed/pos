...
@section('content')
    ...
    <form method="post" action="{{route('dashboard.clients.update',$client->id)}}">
        ...
        <div class="form-group bg-light">
            ...
            <input type="text" name="name" value="{{$client->name}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="{{trans('main_trans.Name')}}">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="phone" value="{{$client->phone}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="{{trans('main_trans.phone')}}">
        </div>


        <div class="form-group">
            <label for="exampleFormControlTextarea1">{{trans('main_trans.address')}}</label>
            <textarea class="form-control ckeditor" value="{{$client->address}}" name="address" id="exampleFormControlTextarea1" rows="3">{{$client->address}}</textarea>
        </div>
